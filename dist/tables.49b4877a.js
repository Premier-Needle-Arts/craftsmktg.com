...
})({"dLAdk":[function(require,module,exports) {
...
/*!
  ...
  */ var global = arguments[3];
!function(t, e) {
    e(exports, require("6f183d4c2cf09ec5"));
}(this, function(t, e) {
    "use strict";
    function n(t) {
    ...
    var D = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator, N = function() {
        for(var t = [
            ...
            "Trident",
            "Firefox"
        ], e = 0; e < t.length; e += 1)if (D && navigator.userAgent.indexOf(t[e]) >= 0) return 1;
        return 0;
    }();
    ...
    function R(t) {
        ...
        return i && "BODY" !== i && "HTML" !== i ? -1 !== [
            ...
            "TD",
            "TABLE"
        ].indexOf(n.nodeName) && "static" === I(n, "position") ? R(n) : n : t ? t.ownerDocument.documentElement : document.documentElement;
    }
    function H(t) {
    ...
    function bt(t, e) {
        Object.keys(e).forEach(function(n) {
            ...
            -1 !== [
                ...
                "bottom",
                "left"
            ].indexOf(n) && _t(e[n]) && (i = "px"), t.style[n] = e[n] + i;
        });
    }
            ...
            offset: {
                ...
                fn: function(t, e) {
                    ...
                    return l = _t(+n) ? [
                        +n,
                        0
                    ] : kt(n, r, a, s), "left" === s ? (r.top += l[0], r.left -= l[1]) : "right" === s ? (r.top += l[0], r.left += l[1]) : "top" === s ? (r.left += l[0], r.top -= l[1]) : "bottom" === s && (r.left += l[0], r.top += l[1]), t.popper = r, t;
                },
                offset: 0
            },
            preventOverflow: {
            ...
            arrow: {
                ...
                fn: function(t, e) {
                    ...
                    var o = t.placement.split("-")[0], r = t.offsets, a = r.popper, s = r.reference, l = -1 !== [
                        "left",
                        "right"
                    ].indexOf(o), u = l ? "height" : "width", f = l ? "Top" : "Left", d = f.toLowerCase(), c = l ? "left" : "top", h = l ? "bottom" : "right", p = rt(i)[u];
            ...
            flip: {
                ...
                fn: function(t, e) {
                    ...
                    return a.forEach(function(s, l) {
                        ...
                        var u = t.offsets.popper, f = t.offsets.reference, d = Math.floor, c = "left" === i && d(u.right) > d(f.left) || "right" === i && d(u.left) < d(f.right) || "top" === i && d(u.bottom) > d(f.top) || "bottom" === i && d(u.top) < d(f.bottom), h = d(u.left) < d(n.left), p = d(u.right) > d(n.right), m = d(u.top) < d(n.top), g = d(u.bottom) > d(n.bottom), v = "left" === i && h || "right" === i && p || "top" === i && m || "bottom" === i && g, _ = -1 !== [
                            "top",
                            "bottom"
                        ].indexOf(i), b = !!e.flipVariations && (_ && "start" === r && h || _ && "end" === r && p || !_ && "start" === r && m || !_ && "end" === r && g), y = !!e.flipVariationsByContent && (_ && "start" === r && p || _ && "end" === r && h || !_ && "start" === r && g || !_ && "end" === r && m), w = b || y;
...
},{}]},["dLAdk","8liRJ"], "8liRJ", "parcelRequireca33")

//# sourceMappingURL=tables.49b4877a.js.map
